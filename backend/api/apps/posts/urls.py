...
from apps.posts.view.generics import (
    PostListCreateView,
...
urlpatterns = [
    ...
    path('', PostListCreateView.as_view(), name='list_posts'),  # GET all posts
    # path('create/', views.create_post, name='create_post'),  # POST create text post
    path('<uuid:post_id>/', PostUpdateDestroyView.as_view(), name='post_detail'),  # GET/PATCH/DELETE
