...
class Message(models.Model):
    """A single message inside a :class:`Chat`."""
    ...
    # Soft-delete support. ``deleted_at`` signals tombstoning; ``deleted_mode``
    # distinguishes "for me" from "for everyone".
    ...
    class Meta:
        # NOTE: We do NOT set a global ordering here because different
        # endpoints paginate in different directions (history newest-first,
        # catch-up oldest-first). Order explicitly in queries.
        indexes = [
